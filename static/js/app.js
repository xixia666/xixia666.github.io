...
(function () {
  ...
  var ICONS = {
    qq: '<svg viewBox="0 0 64 64" fill="currentColor"><path d="M33.5 4C19.4 4 16 14.5 16 24.2c0 3.5.6 6.8 1.6 9.6-1.2 2.4-3 6.3-3 8.2 0 1.2.8 1.9 2 1.9 1.7 0 4.3-1.2 6.2-2.4 1 1.2 2.4 2.2 3.8 2.9-.5 1-1 2.2-1 3.4 0 1 .8 1.5 1.7 1.5 1.5 0 3.4-.7 5-1.7 1 .2 2 .3 3 .3s2-.1 3-.3c1.6 1 3.5 1.7 5 1.7.9 0 1.7-.5 1.7-1.5 0-1.2-.5-2.4-1-3.4 1.4-.7 2.8-1.7 3.8-2.9 1.9 1.2 4.5 2.4 6.2 2.4 1.2 0 2-.7 2-1.9 0-1.9-1.8-5.8-3-8.2 1-2.8 1.6-6.1 1.6-9.6C51 14.5 47.6 4 33.5 4zm-4.8 14c2.2 0 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4 1.8-4 4-4zm9.6 0c2.2 0 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4 1.8-4 4-4zM22 28c1.5 0 2.7 1.2 2.7 2.7S23.5 33.4 22 33.4s-2.7-1.2-2.7-2.7S20.5 28 22 28zm23 0c1.5 0 2.7 1.2 2.7 2.7s-1.2 2.7-2.7 2.7-2.7-1.2-2.7-2.7S43.5 28 45 28z"/></svg>',
